...
define('AUTH_ALL', 					0);
define('AUTH_REG', 					1);//dejiang append注册用户授权
define('AUTH_ACL', 					2);//普通
define('AUTH_MOD', 					3);//版主授权
define('AUTH_ADMIN', 				5);//admin 授权
...
define('TOPICS_JOIN_TABLE', 		$table_prefix.'topics_join');
