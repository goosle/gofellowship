...
<!-- BEGIN switch_allow_subject_on -->
		...
		<div id="chekbox-hide-author">
							<input type="checkbox" name="hide_author" {S_HIDE_AUTHOR} /> 匿名发表
		</div>
...
<!-- BEGIN bb_panel -->
						<div id="bbcode" style="font-weight: bold;">
							...
							<a href="javascript:void(0);" onclick="bbcode('color');">颜色</a>
							...
							<a href="javascript:void(0);" onclick="bbcode('audio');">声音</a>
							<a href="javascript:void(0);" onclick="bbcode('video');">视频</a>
							<a href="javascript:void(0);" onclick="bbcode('flash');">flash</a>
						</div>
