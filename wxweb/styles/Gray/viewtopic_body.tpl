			<div id="main">
				<div class="nav"><a href="./">首页</a>&gt;<a href="{U_FORUM}">{FURUM_CENTER_NAME}</a>&gt;<a href="{U_VIEW_FORUM}">{FORUM_NAME}</a>&gt;查看帖子</div>
				{POLL_DISPLAY}
					...
					<div class="nav-post">
						<div class="left">
                            ...
                            <div class="topic-info">								          
					        	{postrow.POSTER_INFO}						
						        {postrow.REPLY}{postrow.QUOTE}{postrow.EDIT}{postrow.DELETE}{postrow.IP}
						   </div>
						   <div class="topic-info">
						       {postrow.JOIN}
						       {postrow.POST_DATE}
